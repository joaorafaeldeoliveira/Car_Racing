...
from pygame import KEYDOWN, Surface, Rect, K_RETURN, K_BACKSPACE, K_ESCAPE
from code.Const import C_RED, MENU_OPTION, C_WHITE, SCORE_POS
...
class Score:
  ...
  def save(self, game_mode: str, player_score: list[int]):
    ...
    while True:
      ...
      if game_mode == MENU_OPTION[0]:
        ...
        text = 'Enter Player1 name(4characters):'
      if game_mode == MENU_OPTION[1]:
        score = (player_score[0] + player_score[1] / 2)
        text = 'Enter Team name(4characters):'
  ...
  def show(self):
    ...
    self.score_text(20, 'NAME     SCORE           DATE      ', C_RED,
                    SCORE_POS['Label'])
    db_proxy = DBProxy('DBScore')
